    ...
    return (
        <Box variant='div' className={classes.aboutMeContainer}>
            ...
            <Box variant='div' className={classes.aboutMeContent}>
                ...
                <Typography variant='body1'>You can contact me through my website <a target='_blank' href='https://hh-portfolio.com'>hh-portfolio.com</a> and if you are interested in coding with me or contributions just let me know.</Typography>
            </Box>
        </Box>
    )
